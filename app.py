...
# Histograma para a Distribuição das Faixas de Preço
st.subheader('Distribuição da Faixa de Preço')
fig, ax = plt.subplots(figsize=(10, 6))

# Definir os intervalos do histograma para garantir que todas as faixas sejam exibidas
...
# Adicionar as contagens diretamente no gráfico
for p in ax.patches:
...
# Histograma para a Distribuição das Estrelas com Curva de Densidade Suavizada
...
# Box Plot para a Relação entre Faixa de Preço e Número de Estrelas
...
# Tendência da Média de Avaliações ao Longo do Tempo
